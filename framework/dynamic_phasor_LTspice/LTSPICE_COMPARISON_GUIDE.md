...
Open [`03_circuitSim.ipynb`](../notebooks/03_circuitSim.ipynb) and add a new cell:
...
- Validation notebook: [`../notebooks/03_circuitSim.ipynb`](../notebooks/03_circuitSim.ipynb)
